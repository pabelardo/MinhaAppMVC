...
{
    [HtmlTargetElement("*", Attributes = "supress-by-claim-name")] //Primeiro Atributo -    Está atribuindo esse elemento para todos os atributos de html
    ...
    public class ApagaElementoByActionTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            var action = _contextAccessor.HttpContext.GetRouteData().Values["action"].ToString(); //forma de buscar uma action dentro de um request
